...
void showField() {
  ...
  if (count1 < stacks[2].size()) {
    count1 = stacks[2].size();
  }
  if (count1 < stacks[3].size()) {
    count1 = stacks[3].size();
  }
  if (count1 < stacks[4].size()) {
  ...
  for (int i = 0; i < count1; i++) {
    ...
    if (i < stacks[1].size()) {
      cout << stacks[1][i].topEdge;
    } else {
      cout << "         ";
    }
    if (i < stacks[2].size()) {
      cout << stacks[2][i].topEdge;
    } else {
      cout << "         ";
    }
    if (i < stacks[3].size()) {
      cout << stacks[3][i].topEdge;
    } else {
      cout << "         ";
    }
    if (i < stacks[4].size()) {
      cout << stacks[4][i].topEdge;
    } else {
      cout << "         ";
    }
    cout << endl;
    ...
    if (i < stacks[1].size()) {
      cout << stacks[1][i].graphicTop;
    } else {
      cout << "         ";
    }
    if (i < stacks[2].size()) {
      cout << stacks[2][i].graphicTop;
    } else {
      cout << "         ";
    }
    if (i < stacks[3].size()) {
      cout << stacks[3][i].graphicTop;
    } else {
      cout << "         ";
    }
    if (i < stacks[4].size()) {
      cout << stacks[4][i].graphicTop;
    } else {
      cout << "         ";
    }
    cout << endl;
    ...
    if (i < stacks[1].size()) {
      cout << stacks[1][i].graphicMiddle;
    } else {
      cout << "         ";
    }
    if (i < stacks[2].size()) {
      cout << stacks[2][i].graphicMiddle;
    } else {
      cout << "         ";
    }
    if (i < stacks[3].size()) {
      cout << stacks[3][i].graphicMiddle;
    } else {
      cout << "         ";
    }
    if (i < stacks[4].size()) {
      cout << stacks[4][i].graphicMiddle;
    } else {
      cout << "         ";
    }
    cout << endl;
